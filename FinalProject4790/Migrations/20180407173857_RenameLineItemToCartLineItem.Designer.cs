...
namespace FinalProject4790.Migrations
{
    ...
    [Migration("20180407173857_RenameLineItemToCartLineItem")]
    partial class RenameLineItemToCartLineItem
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FinalProject4790.Models.Domain.CartLineItem", b =>
                {
                    b.Property<int>("CartLineItemId")
                        .ValueGeneratedOnAdd();

                    b.Property<int>("CartLineItemProductId");

                    b.Property<int>("CartLineItemQuantity");

                    b.Property<string>("CartShoppingCartId");

                    b.HasKey("CartLineItemId");

                    b.HasIndex("CartLineItemProductId");
            ...
            modelBuilder.Entity("FinalProject4790.Models.Domain.CartLineItem", b =>
                {
                    b.HasOne("FinalProject4790.Models.Domain.Product", "CartLineItemProduct")
                        .WithMany()
                        .HasForeignKey("CartLineItemProductId")
